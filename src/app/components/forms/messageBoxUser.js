...
export default function MessageBox({ userMessage, nameUser }) {
    return (
        <div className="flex w-[100%] h-auto items-center justify-end text-[#5686E1]  text-[12px] sm:text-[18px]" >

            <div className="flex flex-col text-end w-auto h-[100%] text-[#5686E1] text-[12px] sm:text-[18px]" >
            {nameUser}
