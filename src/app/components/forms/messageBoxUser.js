...
export default function MessageBox({ userMessage }) {
    return (
        <div className="flex w-[100%] h-auto items-center justify-end" >

            <div className=" w-auto h-[100%] text-[#5686E1] font-bold text-[12px] sm:text-[18px]" >
